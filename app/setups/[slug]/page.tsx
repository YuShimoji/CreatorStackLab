...
import { findSetupBySlug, getEvidencePassportBundle, listSetups } from "../../../data/repository";
...
export default async function SetupDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="section-shell detail-shell">
      ...
      <section className="conclusion-box"><p className="section-kicker">ROUTE VERDICT</p><h2>{record.summary}</h2><p>公式文書の照合結果です。実機試験は未実施です。</p></section>
